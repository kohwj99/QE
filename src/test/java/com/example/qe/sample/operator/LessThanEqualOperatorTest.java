...
class LessThanEqualOperatorTest {
    ...
    private LessThanEqualOperator operator;
    ...
    @Test
    void apply_givenBigDecimalFieldAndValue_shouldReturnLessThanEqualCondition() {
        // Arrange
    ...
    @Test
    void apply_givenLocalDateFieldAndValue_shouldReturnLessThanEqualCondition() {
        // Arrange
    ...
    @Test
    void apply_givenZeroBigDecimalValue_shouldReturnLessThanEqualCondition() {
        // Arrange
        Field<BigDecimal> field = DSL.field("salary", BigDecimal.class);
    ...
    @Test
    void apply_givenPastLocalDateValue_shouldReturnLessThanEqualCondition() {
        // Arrange
        Field<LocalDate> field = DSL.field("created_date", LocalDate.class);
