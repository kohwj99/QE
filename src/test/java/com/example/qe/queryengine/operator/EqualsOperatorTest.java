...
class EqualsOperatorTest {
    ...
    @Test
    void apply_givenStringFieldAndValue_shouldReturnEqualsCondition() {
    ...
    @Test
    void apply_givenBigDecimalFieldAndValue_shouldReturnEqualsCondition() {
    ...
    @Test
    void apply_givenBooleanFieldAndValue_shouldReturnEqualsCondition() {
    ...
    @Test
    void apply_givenLocalDateFieldAndValue_shouldReturnEqualsCondition() {
    ...
    @Test
    void apply_givenZeroNumeric_shouldReturnEqualsCondition() {
    ...
    @Test
    void apply_givenFalseBoolean_shouldReturnEqualsCondition() {
    ...
    @Test
    void apply_givenEpochDate_shouldReturnEqualsCondition() {
    ...
    @Test
    void apply_givenNegativeNumeric_shouldReturnEqualsCondition() {
