...
class GreaterThanEqualOperatorIntegrationTest extends OperatorIntegrationTest {
    ...
    void parseJsonToCondition_givenGreaterThanEqualOperatorWithPositiveCases_shouldReturnConditionSuccessfully(QueryTestCase testCase) {
