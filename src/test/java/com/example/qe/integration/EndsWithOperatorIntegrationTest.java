...
class EndsWithOperatorIntegrationTest {
    ...
    void parseJsonToCondition_givenEndsWithOperatorWithPositiveCases_shouldReturnConditionSuccessfully(QueryTestCase testCase) throws Exception {
