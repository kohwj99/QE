...
class StartsWithOperatorIntegrationTest {
    ...
    void parseJsonToCondition_givenStartsWithOperatorWithPositiveCases_shouldReturnConditionSuccessfully(QueryTestCase testCase) throws Exception {
    ...
    void parseJsonToCondition_givenStartsWithOperatorWithEdgeCases_shouldHandleOrThrowException(QueryTestCase testCase) {
        ...
        if (testCase.value().isEmpty()) {
            ...
            Condition condition = assertDoesNotThrow(() -> queryExecutionService.parseJsonToCondition(jsonInput));
