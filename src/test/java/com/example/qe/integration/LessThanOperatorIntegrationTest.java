...
class LessThanOperatorIntegrationTest {
    ...
    void parseJsonToCondition_givenLessThanOperatorWithPositiveCases_shouldReturnConditionSuccessfully(QueryTestCase testCase) throws Exception {
